...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-9HSFQ7C5;Initial Catalog=BookEcommerce;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BanBe>(entity =>
        {
            ...
            entity.HasOne(d => d.MaSachNavigation).WithMany(p => p.BanBes)
                .HasForeignKey(d => d.MaSach)
                .HasConstraintName("FK_QuangBa_Sach");
        });
